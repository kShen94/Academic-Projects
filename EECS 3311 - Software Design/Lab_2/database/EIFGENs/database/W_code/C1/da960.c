...
extern EIF_TYPED_VALUE F960_7147(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7148(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7149(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7150(EIF_REFERENCE);
extern EIF_TYPED_VALUE F960_7151(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F960_7144,13424,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13424);
	RTSA(Dtype(Current));
	RTSC;
...
RTOID (F960_7147)
EIF_TYPED_VALUE F960_7147 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F960_7148)
EIF_TYPED_VALUE F960_7148 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 959, Current, 0, 0, 13427);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F960_7149 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F960_7149,13429,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F960_7150,13430,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F960_7151 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F960_7151,13431,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit960 (void)
{
	GTCX
	RTOTS (7144,F960_7144)
	RTOTS (7145,F960_7145)
	RTOTS (7146,F960_7146)
	RTOTS (7147,F960_7147)
	RTOTS (7148,F960_7148)
	RTOTS (7149,F960_7149)
	RTOTS (7150,F960_7150)
	RTOTS (7151,F960_7151)
}
