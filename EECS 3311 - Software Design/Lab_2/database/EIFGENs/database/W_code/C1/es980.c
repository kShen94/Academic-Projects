...
extern void F980_7371(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F980_7372(EIF_REFERENCE);
...
void F980_7371 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
void F980_7372 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 979, Current, 3, 0, 13622);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F980_7373 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 13623);
	RTSA(Dtype(Current));
	RTSC;
