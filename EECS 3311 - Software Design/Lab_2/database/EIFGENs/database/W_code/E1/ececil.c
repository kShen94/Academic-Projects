...
void A166_160 (EIF_REFERENCE Current, EIF_POINTER arg1, EIF_POINTER arg2)
{
	...
	/* DATABASE_TESTS test_add_existing_key */
void _A966_78 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5061, "test_add_existing_key", closed [1].it_r))(closed [1].it_r);
}

	/* DATABASE_TESTS test_remove_nonexisting_key */
void _A966_79 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5062, "test_remove_nonexisting_key", closed [1].it_r))(closed [1].it_r);
}

	/* DATABASE_TESTS test_unique_keys */
void _A966_80 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5063, "test_unique_keys", closed [1].it_r))(closed [1].it_r);
}

	/* DATABASE_TESTS test_exists_with_nonmatching_values */
EIF_TYPED_VALUE _A966_81 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5064, "test_exists_with_nonmatching_values", closed [1].it_r))(closed [1].it_r);
}
