...
{
	GTCX
	RTOTC (F1105_10576,16883,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16883);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16883);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16884);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16884);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16885);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16885);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16886);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16886);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F1105_10581,16888,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F1105_10582,16889,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F1105_10583,16890,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit1105 (void)
{
	GTCX
	RTOTS (10576,F1105_10576)
	RTOTS (10577,F1105_10577)
	RTOTS (10578,F1105_10578)
	RTOTS (10579,F1105_10579)
	RTOTS (10580,F1105_10580)
	RTOTS (10581,F1105_10581)
	RTOTS (10582,F1105_10582)
	RTOTS (10583,F1105_10583)
}
