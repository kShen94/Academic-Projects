...
extern EIF_TYPED_VALUE F1070_10289(EIF_REFERENCE);
...
RTOID (F1070_10289)
EIF_TYPED_VALUE F1070_10289 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1069, Current, 0, 0, 16619);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1069, Current, 16619);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
