...
extern void F1461_15734(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1461_15735(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1461_15736(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1461_15737(EIF_REFERENCE);
extern void F1461_25387(EIF_REFERENCE, int);
...
void F1461_15734 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1460, Current, 1, 1, 22443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 13172, 0x10000000, 1); /* count */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1782, "count", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(13172, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	...
	if (RTAL & CK_ENSURE) {
		...
		ui4_1 = ti4_1;
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13171, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		if (RTEQ(tr1, arg1)) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1461_15735 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1460, Current, 2, 1, 22444);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	loc1 = *(EIF_INTEGER_32 *)(Current + RTWA(13172, dtype));
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(13172, dtype));
...
void F1461_25387 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1460, Current, 0, 25386);
	RTSA(dtype);
	RTME(dtype, 0);
