...
extern void F1861_22434(EIF_REFERENCE);
extern void F1861_22435(EIF_REFERENCE);
extern void F1861_22436(EIF_REFERENCE);
...
void F1861_22434 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_6 ui4_6x.it_i4
	...
	RTEAA(l_feature_name, 1860, Current, 0, 0, 28492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1860, Current, 28492);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1861_22435 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1860, Current, 1, 0, 28493);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1860, Current, 28493);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(2,2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9259, "theme_changed_actions", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,3);
	ur1 = NULL;
...
void F1861_22436 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1860, Current, 2, 0, 28494);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1860, Current, 28494);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(18584, 1857))(Current);
	RTHOOK(2);
	RTDBGAL(Current, 1, 0xF8000612, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1554, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
