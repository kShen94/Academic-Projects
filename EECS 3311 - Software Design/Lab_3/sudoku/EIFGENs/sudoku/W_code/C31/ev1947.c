...
extern void F1947_24769(EIF_REFERENCE);
extern void F1947_24770(EIF_REFERENCE);
extern void F1947_24771(EIF_REFERENCE);
extern void F1947_24772(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1947_24773(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1947_24774(EIF_REFERENCE);
extern void F1947_24775(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1947_24776_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1947_24776(EIF_REFERENCE);
...
void F1947_24769 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30727);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30727);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15544, 1945))(Current);
	RTHOOK(2);
...
void F1947_24770 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1946, Current, 2, 0, 30728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30728);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(19333, 1945))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
...
void F1947_24771 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30729);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30729);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16117, 1945))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F1947_24772 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30730);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30730);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_selectable", EX_PRE);
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7428, 1017))(Current, up1x, ui4_1x, up2x, up3x);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(16119, 1945))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1947_24773 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30731);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1946, Current, 30731);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1947_24774 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30732);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30732);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
void F1947_24775 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1946, Current, 0, 1, 30733);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1946, Current, 30733);
	RTCC(arg1, 1946, l_feature_name, 1, eif_new_type(1551, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1947_24776_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1946, Current, 0, 0, 30734);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1946, Current, 30734);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1947_24776 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15549, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1947_24776_body (Current)).it_r;
