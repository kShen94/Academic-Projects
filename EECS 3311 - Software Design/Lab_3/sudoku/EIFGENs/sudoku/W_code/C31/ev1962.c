...
extern EIF_TYPED_VALUE F1962_18427(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1962_18428(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_18429(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_18430(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_18431(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1962_18432(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1962_18433(EIF_REFERENCE);
extern void F1962_25426(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1962_18427 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1961, Current, 0, 1, 25192);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 25192);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(3,1);
	ur1 = RTCCL(arg1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15918, "item_by_data", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
EIF_TYPED_VALUE F1962_18428 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1961, Current, 0, 0, 25193);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1961, Current, 25193);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1963))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1962_18429 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1961, Current, 3, 0, 25194);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 25194);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc3)) {
			...
			{
				EIF_TYPE_INDEX typarr0[] = {1961,0,0,0xFFFF};
				EIF_TYPE typres0;
				{
					EIF_TYPE l_type;
...
EIF_TYPED_VALUE F1962_18430 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1961, Current, 2, 0, 25195);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 25195);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1962_18431 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1961, Current, 2, 2, 25196);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1961, Current, 25196);
	{
		...
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg1, 1961, l_feature_name, 1, typres0, 0x01);
	}
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,283,0,0,0xFFFF};
		EIF_TYPE typres0;
		...
		typres0 = eif_compound_id(Dftype(Current), typarr0);
		RTCC(arg2, 1961, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F1962_18432 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1962_18433 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1962_25426 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1961, Current, 0, 25425);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15464, dtype))(Current)).it_b);
		tb1 = tb2;
	}
	if (tb1) {
		RTCK;
