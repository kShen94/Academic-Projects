...
extern EIF_TYPED_VALUE F1128_11221(EIF_REFERENCE);
static EIF_TYPED_VALUE F1128_11222_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1128_11222(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1128_11221 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1127, Current, 1, 0, 17528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1127, Current, 17528);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1128_11222_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1127, Current, 0, 0, 17527);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1127, Current, 17527);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1128_11222 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9045,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(9045, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1128_11222_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9045,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
