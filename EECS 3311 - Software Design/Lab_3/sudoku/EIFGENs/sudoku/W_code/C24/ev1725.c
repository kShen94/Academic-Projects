...
EIF_TYPED_VALUE F1725_19680 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16471,Dtype(Current)));
	return r;
}
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1724, Current, 2, 0, 26038);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1725_19689 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1724, Current, 2, 1, 26034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_BOOLEAN)(loc1 != loc2)) {
		...
		*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (tr4_1 * arg1);
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16477, dtype))(Current, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
void F1725_25447 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1724, Current, 0, 25446);
	RTSA(dtype);
	RTME(dtype, 0);
