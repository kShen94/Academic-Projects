...
#define up1 up1x.it_p
	...
	RTCC(arg1, 1024, l_feature_name, 1, eif_new_type(1606, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7580, 0xF8000646, 0); /* pixmap */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7578, 0xF800056A, 0); /* target */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
