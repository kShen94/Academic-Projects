...
extern EIF_TYPED_VALUE F1620_18371(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1620_18372(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1619, Current, 0, 0, 25135);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1619, Current, 25135);
	RTIV(Current, RTAL);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1619, Current, 1, 0, 25136);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1619, Current, 25136);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT(NULL, EX_PRE);
...
EIF_TYPED_VALUE F1620_18371 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1619, Current, 0, 0, 25137);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1619, Current, 25137);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1569))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1578))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1620_18372 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
