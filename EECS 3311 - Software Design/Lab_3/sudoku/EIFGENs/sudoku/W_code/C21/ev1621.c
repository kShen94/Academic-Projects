...
extern EIF_TYPED_VALUE F1621_18373(EIF_REFERENCE);
extern void F1621_18374(EIF_REFERENCE);
extern void F1621_18375(EIF_REFERENCE);
extern void F1621_18376(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1621_18373 (EIF_REFERENCE Current)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 1620, Current, 1, 0, 25139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1620, Current, 25139);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1621_18374 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1620, Current, 0, 0, 25140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1620, Current, 25140);
	RTIV(Current, RTAL);
...
void F1621_18375 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1620, Current, 0, 0, 25141);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1620, Current, 25141);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1621_18376 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1620, Current, 0, 0, 25142);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1620, Current, 25142);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1621_18377 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1620, Current, 0, 0, 25143);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1620, Current, 25143);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tb2 = '\0';
	tb3 = '\0';
	tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1619))(Current)).it_b);
	if (tb4) {
		tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1572))(Current)).it_b);
		tb3 = tb4;
	}
	if (tb3) {
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(14667, 1571))(Current)).it_b);
		tb2 = tb3;
	}
	if (tb2) {
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1620, Current, 0, 0, 25145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14662, 0xF80006C9, 0); /* implementation */
