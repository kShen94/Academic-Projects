...
extern void F1397_14752(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1397_14753(EIF_REFERENCE);
...
void F1397_14752 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1396, Current, 0, 0, 21458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1396, Current, 21458);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1397_14753 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1397_14753,21460,RTMS_EX_H("riched32.dll",12,172585836));
}

void EIF_Minit1397 (void)
{
	GTCX
	RTOTS (14753,F1397_14753)
}
