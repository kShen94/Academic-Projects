...
extern void F1396_14750(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1396_14751(EIF_REFERENCE);
...
void F1396_14750 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1395, Current, 0, 0, 21456);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1395, Current, 21456);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1396_14751 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1396_14751,21458,RTMS_EX_H("comctl32.dll",12,1700689004));
}

void EIF_Minit1396 (void)
{
	GTCX
	RTOTS (14751,F1396_14751)
}
