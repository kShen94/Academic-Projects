...
extern void F1366_14314(EIF_REFERENCE);
...
void F1366_14314 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1365, Current, 0, 0, 20955);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1365, Current, 20955);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7657, "reset", tr1))(tr1);
	RTHOOK(2);
