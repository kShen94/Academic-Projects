...
extern EIF_TYPED_VALUE F1682_19249(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1682_19250(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1682_19251(EIF_REFERENCE);
extern void F1682_19252(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1682_19253(EIF_REFERENCE);
extern void F1682_19254(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1682_19249 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1681, Current, 2, 0, 25803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,851,0xFF01,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
			l_type = RTWCT(15549, dtype, dftype);
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16102, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1682_19250 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1681, Current, 3, 0, 25804);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			RTHOOK(4);
			tb1 = '\01';
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1803, "off", loc3))(loc3)).it_b);
			if (!tb2) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16102, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
				RTDBGAL(Current, 2, 0xF800061B, 0, 0); /* loc2 */
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1771, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(6,1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15549, "interface", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1682_19251 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16106,Dtype(Current)));
	return r;
}


/* {EV_RADIO_PEER_IMP}.set_radio_group */
void F1682_19252 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1681, Current, 2, 1, 25800);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1681, Current, 25800);
	RTCC(arg1, 1681, l_feature_name, 1, RTWCT(16106, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(5);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16109, dtype))(Current, ur1x);
	RTHOOK(6);
	RTDBGAL(Current, 1, 0xF8000353, 0, 0); /* loc1 */
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16106, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(7);
	RTCT0(NULL, EX_CHECK);
...
void F1682_19253 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1681, Current, 1, 0, 25801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16106, 0xF8000353, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16106, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1682_19254 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1681, Current, 0, 1, 25802);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1681, Current, 25802);
	RTCC(arg1, 1681, l_feature_name, 1, RTWCT(16106, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16106, 0xF8000353, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16106, Dtype(Current))) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
