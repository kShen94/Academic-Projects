...
extern EIF_TYPED_VALUE F1798_20592(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1798_20593(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1798_20592 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1797, Current, 0, 0, 26724);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1797, Current, 26724);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1798_20593 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1797, Current, 0, 0, 26725);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1797, Current, 26725);
	RTIV(Current, RTAL);
	RTHOOK(1);
