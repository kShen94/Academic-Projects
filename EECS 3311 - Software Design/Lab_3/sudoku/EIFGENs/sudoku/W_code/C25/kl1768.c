...
extern EIF_TYPED_VALUE F1768_20064(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1768_20064 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1767, Current, 0, 0, 26256);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1767, Current, 26256);
	RTIV(Current, RTAL);
	RTHOOK(1);
