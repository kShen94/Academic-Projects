...
extern void F1271_13090(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1271_13091(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1271_13090 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1270, Current, 0, 1, 19311);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1271_13091 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F1271_13093 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(10831,Dtype(Current)));
	return r;
}
