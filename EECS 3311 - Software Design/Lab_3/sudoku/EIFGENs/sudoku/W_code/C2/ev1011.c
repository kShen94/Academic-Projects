...
extern EIF_TYPED_VALUE F1011_9497(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1011_9498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1011_9499(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1011_9500(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1011_9497 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1011_9498 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1011_9499 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1011_9500 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1010, Current, 0, 1, 15790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1010, Current, 15790);
	RTIV(Current, RTAL);
	RTHOOK(1);
