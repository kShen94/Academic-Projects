...
extern EIF_TYPED_VALUE F991_8965(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F991_8965 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 990, Current, 0, 1, 15254);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
