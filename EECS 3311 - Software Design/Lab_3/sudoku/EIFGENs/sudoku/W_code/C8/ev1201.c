...
extern void F1201_12463(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1200, Current, 0, 0, 18717);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1200, Current, 18717);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
/* {EV_PNG_FORMAT}.save */
void F1201_12463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1200, Current, 0, 2, 18718);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
