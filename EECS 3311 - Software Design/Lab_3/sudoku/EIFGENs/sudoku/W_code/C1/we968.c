...
extern EIF_TYPED_VALUE F968_8734(EIF_REFERENCE);
...
EIF_TYPED_VALUE F968_8734 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,254,0xFF01,969,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15030);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15031);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15021);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15023);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15024);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 967, Current, 1, 0, 15025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTS (8735,F968_8735)
	RTOTS (8736,F968_8736)
	RTOTS (8737,F968_8737)
	RTOTS (8738,F968_8738)
	RTOTS (8739,F968_8739)
	RTOTS (8740,F968_8740)
	RTOTS (8741,F968_8741)
