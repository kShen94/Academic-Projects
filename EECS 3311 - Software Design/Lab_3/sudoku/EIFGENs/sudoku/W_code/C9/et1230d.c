...
static const EIF_TYPE_INDEX egt_13_1230 [] = {0xFF01,272,0xFF01,231,0xFFFF};
...
static const struct desc_info desc_1230[] = {
	...
	{EIF_GENERIC(egt_9_1230), 18996, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1230), 18993, 0},
	{EIF_GENERIC(egt_14_1230), 18994, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1230), 18995, 0xFFFFFFFF},
};
void Init1230(void)
{
	IDSC(desc_1230, 0, 1229);
	IDSC(desc_1230 + 1, 1, 1229);
	IDSC(desc_1230 + 32, 408, 1229);
	IDSC(desc_1230 + 34, 413, 1229);
}
