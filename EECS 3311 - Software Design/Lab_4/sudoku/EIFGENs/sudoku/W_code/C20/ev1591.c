...
extern void F1591_17968(EIF_REFERENCE);
...
void F1591_17968 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1590, Current, 0, 0, 24717);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1590, Current, 24717);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14654, 0xF80006AB, 0); /* implementation */
