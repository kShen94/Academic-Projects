...
extern void F1592_17970(EIF_REFERENCE);
...
void F1592_17970 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1591, Current, 0, 0, 24719);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1591, Current, 24719);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14654, 0xF80006AC, 0); /* implementation */
