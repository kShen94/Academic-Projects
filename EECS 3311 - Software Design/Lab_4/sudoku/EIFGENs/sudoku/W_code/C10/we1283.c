...
extern EIF_TYPED_VALUE F1283_13513(EIF_REFERENCE);
...
RTOID (F1283_13513)
EIF_TYPED_VALUE F1283_13513 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1282, Current, 0, 0, 19734);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1282, Current, 19734);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
