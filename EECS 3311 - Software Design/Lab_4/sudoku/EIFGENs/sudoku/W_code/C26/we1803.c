...
extern EIF_TYPED_VALUE F1803_20590(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1803_20590 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1802, Current, 0, 0, 26708);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1802, Current, 26708);
	RTIV(Current, RTAL);
	RTHOOK(1);
