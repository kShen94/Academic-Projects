...
static EIF_TYPED_VALUE F1677_19126_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1677_19126(EIF_REFERENCE);
extern void F1677_25436(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1677_19126_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1676, Current, 0, 0, 25690);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1676, Current, 25690);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1677_19126 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15541, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1677_19126_body (Current)).it_r;
...
void F1677_25436 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1676, Current, 0, 25435);
	RTSA(dtype);
	RTME(dtype, 0);
