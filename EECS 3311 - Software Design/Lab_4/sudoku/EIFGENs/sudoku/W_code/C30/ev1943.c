...
extern void F1943_24589(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1943_24590(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1943_24591(EIF_REFERENCE);
extern void F1943_24592(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1943_24593(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1943_24594_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1943_24594(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1942, Current, 0, 1, 30537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30537);
	RTCC(arg1, 1942, l_feature_name, 1, RTWCT(15541, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1943_24589 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1942, Current, 0, 0, 30538);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30538);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1943_24590 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1942, Current, 0, 0, 30539);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30539);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1943_24591 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1942, Current, 0, 0, 30540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30540);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1942, Current, 0, 2, 30541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30541);
	RTCC(arg1, 1942, l_feature_name, 1, eif_new_type(1516, 0x01), 0x01);
	RTCC(arg2, 1942, l_feature_name, 2, eif_new_type(1491, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1943_24593 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1942, Current, 0, 3, 30542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1942, Current, 30542);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
static EIF_TYPED_VALUE F1943_24594_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1942, Current, 0, 0, 30543);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1942, Current, 30543);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1943_24594 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15541, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1943_24594_body (Current)).it_r;
