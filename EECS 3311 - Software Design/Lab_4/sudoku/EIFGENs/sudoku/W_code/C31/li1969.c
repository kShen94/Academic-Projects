...
extern EIF_TYPED_VALUE F1969_3627(EIF_REFERENCE);
extern void F1969_3628(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1969_3629(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1969_3630(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1969_3631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1969_3632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1969_3633(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1969_3627 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1968, Current, 1, 0, 20254);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20254);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F1969_3628 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1968, Current, 0, 1, 20255);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20255);
	RTCC(arg1, 1968, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F1969_3629 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1968, Current, 0, 1, 20256);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20256);
	RTCC(arg1, 1968, l_feature_name, 1, RTWCT(1771, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1969_3630 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1968, Current, 0, 1, 20257);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1968, Current, 20257);
	RTCC(arg1, 1968, l_feature_name, 1, RTWCT(1771, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F1969_3631 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1968, Current, 0, 0, 20258);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20258);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1969_3632 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1968, Current, 1, 0, 20259);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20259);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1969_3633 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1968, Current, 3, 1, 20260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1968, Current, 20260);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
