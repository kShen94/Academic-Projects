...
static const EIF_TYPE_INDEX egt_13_1189 [] = {0xFF01,1862,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1189 [] = {0xFF01,640,0xFF01,1862,0xFFFF};
...
static const struct desc_info desc_1189[] = {
	...
	{EIF_GENERIC(egt_13_1189), 18556, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 18557, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1189), 18558, 0xFFFFFFFF},
};
void Init1189(void)
{
	IDSC(desc_1189, 0, 1188);
	IDSC(desc_1189 + 1, 1, 1188);
	IDSC(desc_1189 + 32, 865, 1188);
}
