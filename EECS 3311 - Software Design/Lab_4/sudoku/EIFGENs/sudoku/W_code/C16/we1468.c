...
extern void F1468_15800(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F1468_15806(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1468_15807(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1468_15808(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1468_15800 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1467, Current, 0, 1, 22496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 22496);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 0, 0, 22497);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 22497);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13234, dtype))(Current, up1x)).it_p);
	up1 = tp1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 1, 0, 22498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 22498);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 1, 0, 22499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 22499);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000523, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(1315, 0x01).id);
	tp1 = *(EIF_POINTER *)(Current + RTWA(12162, dtype));
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13236, dtype))(Current, up1x)).it_p);
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(11625, Dtype(tr1)))(tr1, up1x);
	RTNHOOK(1,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1468_15804);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1467, Current, 0, 0, 22500);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1467, Current, 22500);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13233, dtype))(Current)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1468_15805 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1467, Current, 0, 0, 22501);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1468_15806 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 0, 1, 22502);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
...
EIF_TYPED_VALUE F1468_15807 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 0, 1, 22503);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1467, Current, 22503);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1468_15808 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1467, Current, 0, 1, 22504);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
