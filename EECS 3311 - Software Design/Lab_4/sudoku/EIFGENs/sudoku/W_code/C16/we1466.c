...
extern EIF_TYPED_VALUE F1466_15764(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1466_15765(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1466_15766(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1465, Current, 0, 0, 22457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 22457);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(12162, dtype));
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(13195, dtype))(Current, up1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1465, Current, 0, 0, 22458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 22458);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1466_15763);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1465, Current, 0, 0, 22459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1465, Current, 22459);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(13194, dtype))(Current)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1466_15764 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1465, Current, 0, 0, 22460);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1465, Current, 22460);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1466_15765 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1465, Current, 0, 1, 22461);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1465, Current, 22461);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1466_15766 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1465, Current, 0, 1, 22462);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1465, Current, 22462);
	RTIV(Current, RTAL);
