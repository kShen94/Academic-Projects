...
extern void F1903_23253(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1903_23254_body(EIF_REFERENCE);
...
void F1903_23253 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1902, Current, 0, 1, 29279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1903_23254_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1902, Current, 0, 0, 29280);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1903_23254 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15541, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1903_23254_body (Current)).it_r;
