...
extern EIF_TYPED_VALUE F1091_10486(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1091_10486 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1090, Current, 0, 0, 16816);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1090, Current, 16816);
	RTIV(Current, RTAL);
