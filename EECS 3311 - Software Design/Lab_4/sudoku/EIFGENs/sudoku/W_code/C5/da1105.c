...
{
	GTCX
	RTOTC (F1105_10566,16876,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16876);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16876);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16877);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16877);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16878);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16878);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1104, Current, 0, 0, 16879);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1104, Current, 16879);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F1105_10571,16873,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F1105_10572,16874,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F1105_10573,16875,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit1105 (void)
{
	GTCX
	RTOTS (10566,F1105_10566)
	RTOTS (10567,F1105_10567)
	RTOTS (10568,F1105_10568)
	RTOTS (10569,F1105_10569)
	RTOTS (10570,F1105_10570)
	RTOTS (10571,F1105_10571)
	RTOTS (10572,F1105_10572)
	RTOTS (10573,F1105_10573)
}
