...
extern EIF_TYPED_VALUE F1628_18387(EIF_REFERENCE);
extern void F1628_18388(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1628_18387 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1628_18388 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1627, Current, 0, 0, 25138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1627, Current, 25138);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14654, 0xF80006CE, 0); /* implementation */
