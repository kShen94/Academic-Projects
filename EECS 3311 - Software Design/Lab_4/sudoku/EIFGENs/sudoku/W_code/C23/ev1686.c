...
extern EIF_TYPED_VALUE F1686_19245(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1686_19246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1686_19247(EIF_REFERENCE);
extern void F1686_19248(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1686_19249(EIF_REFERENCE);
extern void F1686_19250(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1686_19245 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1685, Current, 2, 0, 25781);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTDBGAL(Current, 0, 0xF8000353, 0,0); /* Result */
	{
		...
		{
			EIF_TYPE l_type;
			l_type = RTWCT(15541, dtype, dftype);
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16094, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1686_19246 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1685, Current, 3, 0, 25782);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16094, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
...
EIF_TYPED_VALUE F1686_19247 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16098,Dtype(Current)));
	return r;
}


/* {EV_RADIO_PEER_IMP}.set_radio_group */
void F1686_19248 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1685, Current, 2, 1, 25784);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1685, Current, 25784);
	RTCC(arg1, 1685, l_feature_name, 1, RTWCT(16098, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16098, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(7);
	RTCT0(NULL, EX_CHECK);
...
void F1686_19249 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16098, 0xF8000353, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16098, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1686_19250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1685, Current, 0, 1, 25786);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1685, Current, 25786);
	RTCC(arg1, 1685, l_feature_name, 1, RTWCT(16098, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 16098, 0xF8000353, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16098, Dtype(Current))) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
