...
static const struct desc_info desc_1024[] = {
	...
	{EIF_NON_GENERIC(0x0ADD /*1390*/), 16007, 0},
	{EIF_GENERIC(egt_13_1024), 16008, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0C95 /*1610*/), 16009, 8},
	{EIF_GENERIC(NULL), 16010, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16011, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16012, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01DB /*237*/), 16013, 16},
};
void Init1024(void)
{
	IDSC(desc_1024, 0, 1023);
	IDSC(desc_1024 + 1, 1, 1023);
	IDSC(desc_1024 + 32, 515, 1023);
}
