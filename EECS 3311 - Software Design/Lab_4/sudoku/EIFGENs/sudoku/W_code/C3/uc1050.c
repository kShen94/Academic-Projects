...
extern EIF_TYPED_VALUE F1050_9993(EIF_REFERENCE);
...
RTOID (F1050_9993)
EIF_TYPED_VALUE F1050_9993 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1049, Current, 0, 0, 16323);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1049, Current, 16323);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
