...
#define arg2 arg2x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10534, 0xF80007D5, 0); /* on_error */
...
#define ur2 ur2x.it_r
	...
	ur2 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(17955, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(17968, "parse_string", loc1))(loc1, ur1x);
	RTHOOK(3);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17957, "last_error", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4598, "is_empty", tr1))(tr1)).it_b);
	if (tb1) {
		RTHOOK(4);
		RTDBGAL(Current, 3, 0xF80000E7, 0, 0); /* loc3 */
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17956, "event_trace", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		...
		*(EIF_BOOLEAN *)(Current + RTWA(10531, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		ur1 = tr4;
		tr4 = ((up3x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4660, "plus", tr3))(tr3, ur1x)), (((up3x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up3x.it_r = RTBU(up3x))), (up3x.type = SK_POINTER), up3x.it_r);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17957, "last_error", loc1))(loc1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr3);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4660, "plus", tr4))(tr4, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		((EIF_TYPED_VALUE *)tr2+1)->it_r = tr3;
		RTAR(tr2,tr3);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1233, Current, 9, 1, 18998);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (RTEQ(loc1, RTMS_EX_H("set_number",10,1295042930))) {
		...
		if (tb1) {
			...
			ti8_1 = *(EIF_INTEGER_64 *)(loc5 + RTVA(10565, "value", loc5));
			((EIF_TYPED_VALUE *)tr3+2)->it_i8 = ti8_1;
			ti8_1 = *(EIF_INTEGER_64 *)(loc6 + RTVA(10565, "value", loc6));
		...
		if (RTEQ(loc1, RTMS_EX_H("start_game",10,911916133))) {
			...
			if (RTEQ(loc1, RTMS_EX_H("put_number",10,2037354098))) {
				...
				if (tb1) {
					...
					ti8_1 = *(EIF_INTEGER_64 *)(loc7 + RTVA(10565, "value", loc7));
					((EIF_TYPED_VALUE *)tr3+1)->it_i8 = ti8_1;
					ti8_1 = *(EIF_INTEGER_64 *)(loc8 + RTVA(10565, "value", loc8));
					((EIF_TYPED_VALUE *)tr3+2)->it_i8 = ti8_1;
					ti8_1 = *(EIF_INTEGER_64 *)(loc9 + RTVA(10565, "value", loc9));
					((EIF_TYPED_VALUE *)tr3+3)->it_i8 = ti8_1;
					ur2 = RTCCL(tr3);
					tr4 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10533, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					ur3 = RTCCL(tr4);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1233, Current, 11, 1, 18999);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
