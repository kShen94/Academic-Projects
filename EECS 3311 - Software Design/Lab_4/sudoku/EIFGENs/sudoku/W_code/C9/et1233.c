...
#define ui4_1 ui4_1x.it_i4
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,2006,0xFF01,231,199,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1232, Current, 6, 0, 18995);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	...
	RTHOOK(8);
	ur1 = RTCCL(loc1);
	tr1 = RTMS_EX_H("set_number",10,1295042930);
	ur2 = tr1;
	...
	RTHOOK(17);
	ur1 = RTCCL(loc3);
	tr1 = RTMS_EX_H("put_number",10,2037354098);
	ur2 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(3067, "extend", Result))(Result, ur1x, ur2x);
	RTHOOK(18);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1232, Current, 6, 0, 18996);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
