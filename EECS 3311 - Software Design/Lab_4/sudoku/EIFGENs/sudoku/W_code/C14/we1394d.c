...
static const EIF_TYPE_INDEX egt_13_1394 [] = {0xFF01,237,0xFFFF};
...
static const struct desc_info desc_1394[] = {
	...
	{EIF_GENERIC(egt_13_1394), 21354, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 21356, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 21357, 0xFFFFFFFF},
};
void Init1394(void)
{
	...
	IDSC(desc_1394 + 34, 873, 1393);
	IDSC(desc_1394 + 44, 1111, 1393);
}
