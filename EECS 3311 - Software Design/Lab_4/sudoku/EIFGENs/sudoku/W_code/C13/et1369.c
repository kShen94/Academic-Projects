/*
 * Code for class ETF_SET_NUMBER_INTERFACE
 */
...
extern void F1369_14308(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void EIF_Minit1369(void);
extern EIF_REFERENCE _A1369_50_2_3_4();
...
/* {ETF_SET_NUMBER_INTERFACE}.make */
void F1369_14308 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1368, Current, 3, 3, 20936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1368, Current, 20936);
	...
	RTCC(arg3, 1368, l_feature_name, 3, eif_new_type(1148, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	...
	*((EIF_INTEGER_32 *)tr3+2) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1369_50_2_3_4, (EIF_POINTER)(0),11876, tr2, 0, 1, -1, tr1, 3);
	}
	tr1 = RTCCL(tr4);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(11860, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (tb1) {
		...
		tr1 = RTMS_EX_H("set_number(",11,819099688);
		...
		*(EIF_INTEGER_64 *)ur3 = loc1;
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(11863, dtype))(Current, ur1x, ur2x, ur3x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr2);
		...
		*(EIF_REFERENCE *)(Current + RTWA(11868, dtype)) = (EIF_REFERENCE) tr1;
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 11862, 0x04000000, 1); /* etf_cmd_error */
