...
extern EIF_TYPED_VALUE F972_8779(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F972_8779 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 15066);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 15066);
	RTIV(Current, RTAL);
	RTHOOK(1);
