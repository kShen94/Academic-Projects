...
{
	GTCX
	RTOTC (F960_7139,13419,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F960_7144,13424,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F960_7145,13425,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F960_7146,13426,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit960 (void)
{
	GTCX
	RTOTS (7139,F960_7139)
	RTOTS (7140,F960_7140)
	RTOTS (7141,F960_7141)
	RTOTS (7142,F960_7142)
	RTOTS (7143,F960_7143)
