...
static const EIF_TYPE_INDEX egt_13_999 [] = {0xFF01,980,0xFFFF};
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,980,0xFFFF};
static const EIF_TYPE_INDEX egt_15_999 [] = {0xFF01,980,0xFFFF};
static const EIF_TYPE_INDEX egt_16_999 [] = {0xFF01,980,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 15363, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 15364, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_999), 15365, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_999), 15366, 0xFFFFFFFF},
};
void Init999(void)
{
	IDSC(desc_999, 0, 998);
	IDSC(desc_999 + 1, 1, 998);
	IDSC(desc_999 + 32, 899, 998);
}
