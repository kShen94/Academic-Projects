...
extern EIF_TYPED_VALUE F1837_20541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1837_20542(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1837_20543(EIF_REFERENCE);
extern void F1837_20544(EIF_REFERENCE);
extern void F1837_20545(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1837_20541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1837_20542 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1837_20543 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1837_20543,26639,RTMS_EX_H("\012",1,10));
}

/* {KL_TEXT_INPUT_FILE}.read_line */
void F1837_20544 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1836, Current, 5, 0, 26639);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1836, Current, 26639);
	RTIV(Current, RTAL);
...
body:;
	...
	RTNHOOK(3,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17114, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr2);
	...
	loc2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17114, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	for (;;) {
		RTHOOK(6);
		if (loc1) break;
		RTHOOK(7);
		...
		RTHOOK(8);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(17113, dtype));
		if (tb1) {
			RTHOOK(9);
			...
			loc3 = *(EIF_CHARACTER_8 *)(Current + RTWA(17115, dtype));
			RTHOOK(12);
			switch (loc3) {
	...
	*(EIF_BOOLEAN *)(Current + RTWA(17113, dtype)) = (EIF_BOOLEAN) loc4;
	if (RTAL & CK_ENSURE) {
		RTHOOK(20);
...
void F1837_20545 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1836, Current, 0, 0, 26640);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1836, Current, 26640);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
