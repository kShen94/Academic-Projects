...
extern void F1839_20548(EIF_REFERENCE);
extern void F1839_20549(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1839_20550(EIF_REFERENCE);
...
void F1839_20548 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1838, Current, 5, 0, 26643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1838, Current, 26643);
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(17113, dtype)) = (EIF_BOOLEAN) loc5;
	if (RTAL & CK_ENSURE) {
		RTHOOK(26);
...
void F1839_20549 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1838, Current, 0, 0, 26644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1838, Current, 26644);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1839_20550 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1839_20550,26646,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1839 (void)
{
	GTCX
	RTOTS (20550,F1839_20550)
}
