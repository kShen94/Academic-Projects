...
extern void F1840_20551(EIF_REFERENCE);
extern void F1840_20552(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1840_20553(EIF_REFERENCE);
...
void F1840_20551 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1839, Current, 4, 0, 26647);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1839, Current, 26647);
	RTIV(Current, RTAL);
...
void F1840_20552 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1839, Current, 0, 0, 26648);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1839, Current, 26648);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("is_open_read", EX_PRE);
...
EIF_TYPED_VALUE F1840_20553 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1840_20553,26647,RTMS_EX_H("\012",1,10));
}

void EIF_Minit1840 (void)
{
	GTCX
	RTOTS (20553,F1840_20553)
}
