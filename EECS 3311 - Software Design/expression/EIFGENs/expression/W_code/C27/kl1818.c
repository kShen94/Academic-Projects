...
extern EIF_TYPED_VALUE F1818_20129(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1818_20129 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1817, Current, 0, 0, 26284);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1817, Current, 26284);
	RTIV(Current, RTAL);
	RTHOOK(1);
