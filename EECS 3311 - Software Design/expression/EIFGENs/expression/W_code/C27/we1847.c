...
extern EIF_TYPED_VALUE F1847_20649(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1847_20650(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1847_20649 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1846, Current, 0, 0, 26744);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1846, Current, 26744);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1847_20650 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1846, Current, 0, 0, 26745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1846, Current, 26745);
	RTIV(Current, RTAL);
	RTHOOK(1);
