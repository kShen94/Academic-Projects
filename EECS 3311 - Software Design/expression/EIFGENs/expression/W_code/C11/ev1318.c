...
#define ui4_1 ui4_1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 2056))(Current);
	RTHOOK(2);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		RTHOOK(3);
		RTDBGAL(Current, 1, 0xF80006AE, 0, 0); /* loc1 */
		...
		RTHOOK(5);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15758, "enable_parented", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
...
#define up1 up1x.it_p
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15759, "disable_parented", loc1))(loc1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
