...
extern EIF_TYPED_VALUE F1218_12709(EIF_REFERENCE);
...
RTOID (F1218_12709)
EIF_TYPED_VALUE F1218_12709 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1217, Current, 0, 0, 18947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
