...
static const struct desc_info desc_1025[] = {
	...
	{EIF_NON_GENERIC(0x0B39 /*1436*/), 16035, 0},
	{EIF_GENERIC(egt_13_1025), 16036, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0CF1 /*1656*/), 16037, 8},
	{EIF_GENERIC(NULL), 16038, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16039, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16040, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01DB /*237*/), 16041, 16},
};
void Init1025(void)
{
	IDSC(desc_1025, 0, 1024);
	IDSC(desc_1025 + 1, 1, 1024);
	IDSC(desc_1025 + 32, 538, 1024);
}
