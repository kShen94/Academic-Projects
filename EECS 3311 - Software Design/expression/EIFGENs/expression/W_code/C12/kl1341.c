...
extern EIF_TYPED_VALUE F1341_14133(EIF_REFERENCE);
...
RTOID (F1341_14133)
EIF_TYPED_VALUE F1341_14133 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 20770);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1340, Current, 20770);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
