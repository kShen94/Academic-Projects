...
extern EIF_TYPED_VALUE F1669_18432(EIF_REFERENCE);
extern void F1669_18433(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1669_18432 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1669_18433 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1668, Current, 0, 0, 25162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1668, Current, 25162);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14677, 0xF80006F9, 0); /* implementation */
