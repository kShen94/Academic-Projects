...
extern void F1970_24022(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1970_24023(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1970_24024(EIF_REFERENCE);
extern void F1970_24025(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1970_24026(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1970_24027(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1970_24028(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1970_24029(EIF_REFERENCE);
extern void F1970_24030(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1970_24031_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1970_24031(EIF_REFERENCE);
...
void F1970_24022 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1969, Current, 0, 1, 29964);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29964);
	RTCC(arg1, 1969, l_feature_name, 1, RTWCT(15564, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1970_24023 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 29965);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29965);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1970_24024 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1970_24025 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1969, Current, 1, 1, 29957);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29957);
	if (arg1) {
		RTCC(arg1, 1969, l_feature_name, 1, eif_new_type(1972, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1970_24026 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1969, Current, 2, 1, 29958);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29958);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1970_24027 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1969, Current, 2, 1, 29959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29959);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
void F1970_24028 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1969, Current, 3, 1, 29960);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29960);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1970_24029 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 29961);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29961);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1970_24030 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1969, Current, 0, 2, 29962);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1969, Current, 29962);
	RTCC(arg1, 1969, l_feature_name, 1, eif_new_type(1562, 0x01), 0x01);
	RTCC(arg2, 1969, l_feature_name, 2, eif_new_type(1537, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1970_24031_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1969, Current, 0, 0, 29963);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1969, Current, 29963);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1970_24031 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15564, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1970_24031_body (Current)).it_r;
