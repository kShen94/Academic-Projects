...
extern EIF_TYPED_VALUE F1280_13183(EIF_REFERENCE);
...
RTOID (F1280_13183)
EIF_TYPED_VALUE F1280_13183 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1279, Current, 0, 0, 19404);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
