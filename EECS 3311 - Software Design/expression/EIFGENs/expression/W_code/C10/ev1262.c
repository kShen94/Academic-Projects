...
/* {EV_ID_IMP}.make_id */
void F1262_12936 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 19171);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1261, Current, 19171);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1261, Current, 0, 0, 19173);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1261, Current, 19173);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1262_25429 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1261, Current, 0, 25428);
	RTSA(dtype);
	RTME(dtype, 0);
