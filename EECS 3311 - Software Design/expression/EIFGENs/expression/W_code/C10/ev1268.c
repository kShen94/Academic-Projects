...
#define ur1 ur1x.it_r
	...
	if (EIF_TEST(loc1)) {
		...
		RTDBGAL(Current, 0, 0xF80007DD, 0,0); /* Result */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,2013,0xFF01,0xFFF9,1,185,0xFF01,284,0xFF01,237,0xFFFF};
			EIF_TYPE typres0;
		...
		RTHOOK(5);
		RTDBGAA(Current, dtype, 10757, 0xF80007DD, 0); /* file_drop_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 10770, 0xF8000532, 0); /* mouse_wheel_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
