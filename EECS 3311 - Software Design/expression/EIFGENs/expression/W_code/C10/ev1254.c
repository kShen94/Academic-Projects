...
static EIF_TYPED_VALUE F1254_12846_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1254_12846(EIF_REFERENCE);
extern void F1254_12847(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1253, Current, 1, 0, 19080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10598, dtype))(Current, ur1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1254_12846_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1254_12846 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(10597, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1254_12846_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(10597,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
void F1254_12847 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1253, Current, 0, 1, 19082);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1253, Current, 19082);
	RTCC(arg1, 1253, l_feature_name, 1, RTWCT(10596, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
