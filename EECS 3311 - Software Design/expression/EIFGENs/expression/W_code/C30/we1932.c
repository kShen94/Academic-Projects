...
extern EIF_TYPED_VALUE F1932_22931(EIF_REFERENCE);
...
RTOID (F1932_22931)
EIF_TYPED_VALUE F1932_22931 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1932_22931);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1931, Current, 0, 0, 28949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1931, Current, 28949);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
