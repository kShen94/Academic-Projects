...
extern EIF_TYPED_VALUE F1937_23030(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1937_23031(EIF_REFERENCE);
extern void F1937_23032(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1937_23033(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1937_23034(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1937_23035(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1937_23030 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1936, Current, 0, 0, 29051);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29051);
	RTIV(Current, RTAL);
...
body:;
	...
	up1 = tp1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(18511, dtype))(Current, up1x)).it_i4);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
EIF_TYPED_VALUE F1937_23031 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1936, Current, 3, 0, 29052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29052);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18341, dtype))(Current)).it_i4);
	RTHOOK(3);
...
void F1937_23032 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1936, Current, 1, 1, 29053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29053);
	if (arg1) {
		RTCC(arg1, 1936, l_feature_name, 1, eif_new_type(228, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	up2 = tp2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7425, 1019))(Current, up1x, up2x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
...
void F1937_23033 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1936, Current, 0, 1, 29048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29048);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
EIF_TYPED_VALUE F1937_23034 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1936, Current, 0, 0, 29049);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29049);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
RTOID (F1937_23035)
EIF_TYPED_VALUE F1937_23035 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1937_23035);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1936, Current, 0, 0, 29050);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1936, Current, 29050);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	...
	ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9585, dtype))(Current)).it_i4);
