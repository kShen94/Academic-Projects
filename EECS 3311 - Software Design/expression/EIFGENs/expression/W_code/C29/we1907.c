...
extern void F1907_22469(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1907_22470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1907_22471(EIF_REFERENCE);
...
void F1907_22469 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1906, Current, 0, 1, 28490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28490);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 18310, 0xF800076E, 0); /* parent */
	*(EIF_REFERENCE *)(Current + RTWA(18310, dtype)) = (EIF_REFERENCE) NULL;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 18636, 0x10000000, 1); /* resource_id */
	*(EIF_INTEGER_32 *)(Current + RTWA(18636, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
...
void F1907_22470 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1906, Current, 1, 1, 28491);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28491);
	RTCC(arg1, 1906, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1907_22471 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1906, Current, 1, 0, 28492);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1906, Current, 28492);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
