...
void egc_init_plug (void)
{
	...
	egc_system_name = "library_data_structure";
	egc_system_location = "C:\\Users\\Kevin\\workspace\\3311\\library_data_structure\\EIFGENs\\library_data_structure\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1536943656;
	...
	egc_rlist[0] = "TEST_DATA_STRUCTURE.make_tests";
	egc_rcdt[0] = 0;
	egc_rcrid[0] = 5060;
	egc_rcarg[0] = 0;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 966; /* TEST_DATA_STRUCTURE */
	}
}
