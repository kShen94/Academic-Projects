...
extern void F979_7360(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F979_7361(EIF_REFERENCE);
...
void F979_7360 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 978, Current, 0, 2, 13610);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5163, 0xF8000146, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F979_7361 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 978, Current, 3, 0, 13611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F979_7362 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 13612);
	RTSA(Dtype(Current));
	RTSC;
