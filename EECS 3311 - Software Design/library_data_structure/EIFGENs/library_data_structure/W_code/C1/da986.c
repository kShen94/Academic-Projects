...
extern void F986_7537(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {DATE_VALUE}.set_date */
void F986_7537 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 3, 13779);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13780);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13781);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 0, 13785);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTC (F986_7550,13793,RTMS_EX_H("compact_date",12,1114629989));
}
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 0, 1, 13793);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
