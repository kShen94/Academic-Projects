...
public class A02FrontEnd extends JFrame implements ItemListener, ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
    	...
    	//checks for proper date formating
    	if(dateRange.isSelected()&&(!fDate.isBlank() || !tDate.isBlank()) && (!fDate.matches(regex) || !tDate.matches(regex))){
    		System.out.println("test");
    		result="Invalid date format, please use YYYY-MM-DD";
    	}
    	else {
    	A02MiddleTier midTier = new A02MiddleTier();
    	//passes parameters to A02MiddleTier
    	result=midTier.query(fDate,tDate, eventConference.isSelected(), eventJournal.isSelected(), eventBook.isSelected(),allDates.isSelected());
    	//outputs the returned query
    	}
